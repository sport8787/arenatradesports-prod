...
BEGIN
  ...
  -- Plano Favorito: ROI auditado positivo (Vitória +13.8%, Over 1.5 +35%, Over 2.5 +50%).
  -- Isenção total das regras de veto de mercado (motor próprio, base estatística distinta).
