DROP FUNCTION IF EXISTS public.refresh_arena_calibration(TEXT, INT);
CREATE OR REPLACE FUNCTION public.refresh_arena_calibration(p_arena TEXT, p_limit INT DEFAULT 50)
RETURNS TABLE(
  out_arena TEXT, out_sample_size INT, out_hit_rate NUMERIC, out_roi NUMERIC,
  out_effective_min_confidence INT, out_delta INT
)
