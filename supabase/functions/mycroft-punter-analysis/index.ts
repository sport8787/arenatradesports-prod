...
serve(async (req) => {
  ...
  try {
    ...
    const {sports=['soccer_brazil_campeonato','soccer_brazil_serie_b','soccer_brazil_campeonato_paulista','soccer_brazil_campeonato_carioca','soccer_brazil_campeonato_mineiro','soccer_brazil_campeonato_gaucho','soccer_brazil_campeonato_baiano','soccer_brazil_campeonato_paranaense','soccer_brazil_campeonato_catarinense','soccer_brazil_campeonato_pernambucano','soccer_brazil_copa_nordeste','soccer_brazil_copa_do_brasil','soccer_brazil_serie_c','soccer_brazil_copa_verde','soccer_conmebol_copa_libertadores','soccer_conmebol_copa_sudamericana','soccer_chile_primera_division','soccer_colombia_primera_a','soccer_ecuador_liga_pro','soccer_peru_primera_division','soccer_uruguay_primera_division','soccer_venezuela_primera_division','soccer_paraguay_division_profesional','soccer_argentina_primera_b','soccer_mexico_ligamx','soccer_uefa_champs_league','soccer_uefa_europa_league','soccer_epl','soccer_england_championship','soccer_england_efl_cup','soccer_england_league1','soccer_spain_la_liga','soccer_spain_segunda_division','soccer_italy_serie_a','soccer_italy_serie_b','soccer_germany_bundesliga','soccer_germany_bundesliga2','soccer_france_ligue_one','soccer_argentina_primera_division','soccer_fifa_world_cup_qualifier_europe','soccer_netherlands_eredivisie','soccer_portugal_primeira_liga','soccer_turkey_super_league','soccer_international_friendlies','soccer_usa_nwsl'],
