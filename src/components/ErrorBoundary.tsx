...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // O browser tenta carregar um chunk com hash antigo que já não existe.
    // Solução: reload automático uma única vez (flag no sessionStorage evita loop).
    const isChunkError =
    ...
    if (isChunkError) {
      ...
      // Segunda falha: limpa flag e mostra tela de erro normal
